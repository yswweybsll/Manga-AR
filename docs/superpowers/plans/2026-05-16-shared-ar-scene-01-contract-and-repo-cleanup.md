...
- [ ] **Step 1: 检查当前 mobile 类型 re-export**
...
- [ ] **Step 2: 在 mobile model 类型中补 legacy shape**
...
- [ ] **Step 3: 在 mobile scene 类型中保留 recent scene local format**
...
- [ ] **Step 4: 在 mobile sync 类型中过渡到 shared 新类型**
...
- [ ] **Step 6: 给旧 syncService 加本地 legacy 类型**
